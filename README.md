...
- **想 TA 了就BIBU一下** —— 屏幕中央那颗像素心心，长按会像小扇面一样展开 6 种情绪：哔卟哔卟、想你、抱一下、快来、晚安、我回来啦。
  松手就发射。对方手机/网页会「哔卟」一声，配着专属像素小动画 + 震动 + 音效（自己合成的小方波，不是随便找的音效文件 🔊）
- **一起走过多少天，它记得比我们都清楚** —— 恋爱天数按自然日算，纪念日、倒计时都收在一个「值得期待」里，配了 **100 款**手绘级像素场景图标（可搜索可分类），每次翻到一个小图标都会「啊，是那天」🌊🍰🚂
